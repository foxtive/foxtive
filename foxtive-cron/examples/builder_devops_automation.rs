...
fn main() {
    ...
    let nightly_build = CronExpression::builder().daily().hour(2).minute(0);
    ...
    let scale_up_morning = CronExpression::builder().weekdays_only().hour(7).minute(30);

    let scale_down_evening = CronExpression::builder().weekdays_only().hour(19).minute(0);
    ...
    let incremental_backup = CronExpression::builder().daily().hour(1).minute(0);
    ...
    let cert_check = CronExpression::builder().daily().hour(6).minute(0);
    ...
    let log_rotation = CronExpression::builder().daily().hour(0).minute(30);

    let log_aggregation = CronExpression::builder().hourly().minute(15);

    let log_analysis = CronExpression::builder().daily().hour(8).minute(0);
    ...
    let stats_update = CronExpression::builder().daily().hour(3).minute(0);
    ...
    let vacuum_analyze = CronExpression::builder().daily().hour(5).minute(0);
    ...
    let critical_checks = CronExpression::builder().seconds_interval(30);

    let standard_checks = CronExpression::builder().minutes_interval(5);

    let summary_reports = CronExpression::builder().hourly().minute(0);

    let daily_digest = CronExpression::builder().daily().hour(9).minute(0);
    ...
    let job_cleanup = CronExpression::builder().hourly().minute(30);

    let pod_autoscale = CronExpression::builder().minutes_interval(2);
    ...
    let vuln_scan = CronExpression::builder().daily().hour(1).minute(0);
    ...
    let cache_purge = CronExpression::builder().daily().hour(4).minute(0);

    let cache_stats = CronExpression::builder().hourly().minute(45);
    ...
    let emergency_deploy = CronExpression::builder().every_minute();

    println!(
        "   Standard window:     {} - 10 AM-4 PM weekdays",
        weekday_deploy.build()
    );
    println!(
        "   Emergency:           {} - Anytime",
        emergency_deploy.build()
    );
    println!();

    // Example 12: Cost optimization
    println!("12. Cloud Cost Optimization:");
    let dev_shutdown = CronExpression::builder().weekdays_only().hour(20).minute(0);

    let dev_startup = CronExpression::builder().weekdays_only().hour(7).minute(0);
