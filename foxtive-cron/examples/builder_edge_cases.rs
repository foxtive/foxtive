...
fn main() {
    ...
    let single_minute = CronExpression::builder()
        .minute(30)
        .hourly();
    
    let interval_minutes = CronExpression::builder()
        .minutes_interval(30)
        .hourly();
    ...
    let morning_range = CronExpression::builder()
        .hours_range(6, 12)
        .daily();
    
    let afternoon_range = CronExpression::builder()
        .hours_range(12, 18)
        .daily();
    
    let evening_range = CronExpression::builder()
        .hours_range(18, 23)
        .daily();
    ...
    let as_range = CronExpression::builder()
        .hours_range(1, 5)
        .daily();
    ...
    let every_10_sec = CronExpression::builder()
        .seconds_interval(10);
    
    let every_5_min = CronExpression::builder()
        .minutes_interval(5);
    
    let every_hour = CronExpression::builder()
        .hourly();
    ...
    let weekdays = CronExpression::builder()
        .weekdays_only()
        .hour(9);
    ...
    let summer = CronExpression::builder()
        .month(Month::June)
        .day_of_month(1);
    ...
    let hourly_preset = CronExpression::builder()
        .hourly();
    
    let daily_preset = CronExpression::builder()
        .daily();
    
    let weekly_preset = CronExpression::builder()
        .weekly();
    
    let monthly_preset = CronExpression::builder()
        .monthly();
    ...
    let chain_a = CronExpression::builder()
        .daily()
        .hour(9)
        .minute(30);
    
    let chain_b = CronExpression::builder()
        .minute(30)
        .hour(9)
        .daily();
    ...
    let retail_hours = CronExpression::builder()
        .daily()
        .hours_range(10, 21);
    ...
    let all_wildcards = CronExpression::builder()
        .every_second();
    
    let minute_wildcard = CronExpression::builder()
        .every_minute();
    ...
    let first_day = CronExpression::builder()
        .day_of_month(1)
        .monthly();
    
    let mid_month = CronExpression::builder()
        .day_of_month(15)
        .monthly();
    
    let last_possible = CronExpression::builder()
        .day_of_month(31)
        .monthly();
